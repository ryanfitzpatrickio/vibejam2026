 ...
 * with empty Origin headers (scripts don't send one). Run this against local dev
 * or a separate staging party with non-production env settings, not your live one.
 *
