...
export default {
  ...
  "primitives": [
    ...
    {
      "id": "primitive-mod9b5wc-18k6m",
      "name": "plane-p8c-b-a-a",
      "type": "plane",
      "spawnType": null,
      "position": {
        "x": -3.9469,
    ...
    {
      "id": "primitive-mo7rqaxv-i4yjp",
      "name": "plane-5qx-copy-a",
      "type": "plane",
      "spawnType": null,
      "position": {
        "x": 12,
    ...
    {
      "id": "primitive-mo7qw8in-zrsng",
      "name": "plane-eeq-a-a-a-a-a",
      "type": "plane",
      "spawnType": null,
      "position": {
        "x": -26,
    ...
    {
      "id": "primitive-mo7qw8in-6kb68",
      "name": "plane-eeq-a-a-a-a-b",
      "type": "plane",
      "spawnType": null,
      "position": {
        "x": -26,
    ...
    {
      "id": "primitive-mo7qvuha-jmmoi",
      "name": "plane-eeq-a-a-a-b",
      "type": "plane",
      "spawnType": null,
      "position": {
        "x": -26,
    ...
    {
      "id": "primitive-mo7p7pfl-ngk72",
      "name": "plane-eeq-a-a-copy",
      "type": "plane",
      "spawnType": null,
      "position": {
        "x": 0,
      ...
      "rotation": {
        "x": -3.1415923265200276,
        "y": 0,
        "z": -1.5707966669960267
      },
      "scale": {
        "x": 12,
        "y": 48,
    ...
    {
      "id": "primitive-mo7p7wlx-gyvg7",
      "name": "plane-eeq-a-a-copy-copy",
      "type": "plane",
      "spawnType": null,
      "position": {
        "x": 26,
    ...
    {
      "id": "primitive-mo7rj2ze-ur4du",
      "name": "box-wh2-copy-copy",
      "type": "box",
      "spawnType": null,
      "position": {
        "x": -25,
    ...
    {
      "id": "primitive-mo7rj5wp-0o48g",
      "name": "box-wh2-copy-copy-copy",
      "type": "box",
      "spawnType": null,
      "position": {
        "x": 25,
    ...
    {
      "id": "primitive-mo7sau0k-kmin9",
      "name": "plane-5qx-a-copy",
      "type": "plane",
      "spawnType": null,
      "position": {
        "x": 12,
    ...
    {
      "id": "primitive-mo7sk9pk-l0agn",
      "name": "plane-eeq-a-a-a-b-copy-copy-a-a",
      "type": "plane",
      "spawnType": null,
      "position": {
        "x": -25,
    ...
    {
      "id": "prefab-instance-mod8jsrc-9i7v6-part-2",
      "name": "counter Copy-box-part",
      "type": "box",
      "spawnType": null,
      "position": {
    ...
    {
      "id": "prefab-instance-mod8jsrc-9i7v6-part-3",
      "name": "counter Copy-box-part",
      "type": "box",
      "spawnType": null,
      "position": {
    ...
    {
      "id": "prefab-instance-mod8jsrc-9i7v6-part-4",
      "name": "counter Copy-open shelf",
      "type": "plane",
      "spawnType": null,
      "position": {
        "x": 4,
    ...
    {
      "id": "prefab-instance-mod8jsrc-9i7v6-part-6",
      "name": "counter Copy-cupboard wall",
      "type": "plane",
      "spawnType": null,
      "position": {
        "x": 6.006,
    ...
    {
      "id": "prefab-instance-mod8jsrc-9i7v6-part-7",
      "name": "counter Copy-cupboard wall-copy",
      "type": "plane",
      "spawnType": null,
      "position": {
        "x": 4,
    ...
    {
      "id": "prefab-instance-mod8jsrc-9i7v6-part-8",
      "name": "counter Copy-cupboard wall-copy-copy",
      "type": "plane",
      "spawnType": null,
      "position": {
        "x": 2.9962,
    ...
    {
      "id": "prefab-instance-mod8jsrc-9i7v6-part-10",
      "name": "counter Copy-box-part-copy",
      "type": "box",
      "spawnType": null,
      "position": {
        "x": 2,
    ...
    {
      "id": "prefab-instance-mod8jsrc-9i7v6-part-11",
      "name": "counter Copy-wedge-part",
      "type": "wedge",
      "spawnType": null,
      "position": {
        "x": -3,
    ...
    },
    {
      ...
      "name": "counter Copy-box-part-copy-copy",
      "type": "box",
      "spawnType": null,
      "position": {
        "x": -4.9756,
    ...
    },
    {
      ...
      "glbAssetId": "asset-prop-burger-001",
      "glbProp": true,
      "catFavoriteToy": true,
      "mount": false,
      "mountKind": null,
    ...
    },
    {
      ...
      "glbAssetId": "asset-prop-fries-001",
      "glbProp": true,
      "catFavoriteToy": false,
      "mount": false,
      "mountKind": null,
    ...
    },
    {
      ...
      "glbAssetId": "asset-mount-bird-001",
      "glbProp": false,
      "catFavoriteToy": false,
      "mount": true,
      "mountKind": "love-bird",
  ...
  "lights": [
    ...
    {
      "id": "light-mo7r5mqh-zds9y",
      "name": "directional-light-d54",
    ...
    {
      "id": "light-mo7rg08t-2qjgr",
      "name": "point-light-27z",
      "lightType": "directional",
      "position": {
        "x": -12,
        "y": 7.25,
  ...
  "vegetation": [
    ...
    {
      "id": "veg-mo7g75gk-zny8s",
      "name": "firsttree-kjb",
      "speciesId": "tree-glb-a",
      "mode": "single",
      "position": {
        "x": -42,
        "y": -0.5,
