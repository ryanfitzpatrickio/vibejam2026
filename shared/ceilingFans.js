...
export function normalizeCeilingFan(entry = {}) {
  return {
    ...
    bladeLength: clampNumber(entry.bladeLength, 0.45, 2.4, DEFAULT_CEILING_FAN_BLADE_LENGTH),
    hubRadius: clampNumber(entry.hubRadius, 0.08, 0.55, DEFAULT_CEILING_FAN_HUB_RADIUS),
